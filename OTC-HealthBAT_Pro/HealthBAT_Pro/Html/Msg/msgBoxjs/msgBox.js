...
var chartObj = {
    ...
    contentMsg: function (content, messagetype, value,cfid, diseasename) {
        if (messagetype == 1) {//文字
            contents = "<i class=\"msg-info\" msgtype='" + messagetype + "' value='" + value + "'></i><div class=\"msg-txt\">" + content + "</div>";
        }
    ...
    addMsg: function (msgTxt, isme, photourl, msgtype, isnew) {
        ...
        msgHtml += '<div class="msg-con">' +
            '<img src="' + photourl + '" alt="" class="roundness user-header" width="45" height="45" />' +
