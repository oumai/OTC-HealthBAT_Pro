//
//  BATFinishedOrderViewController.m
//  HealthBAT_Pro
//
...
@interface BATFinishedOrderViewController ()<UITableViewDataSource,UITableViewDelegate>
...
@implementation BATFinishedOrderViewController
...
- (void)getOTCOrderListRequest
{
    ...
    [dict setObject:@"5" forKey:@"orderStatus"];
    [HTTPTool requestWithOTCURLString:@"/api/order/GetOrderList" parameters:dict type:kGET success:^(id responseObject) {
        ...
        NSLog(@"已完成responseObject = %@",responseObject);
