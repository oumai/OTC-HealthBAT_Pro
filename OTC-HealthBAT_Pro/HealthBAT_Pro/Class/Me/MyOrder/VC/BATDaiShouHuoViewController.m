...
@interface BATDaiShouHuoViewController ()<UITableViewDataSource,UITableViewDelegate>
...
@implementation BATDaiShouHuoViewController
...
- (void)getOTCOrderListRequest
{
    ...
    [dict setObject:@"3" forKey:@"orderStatus"];
