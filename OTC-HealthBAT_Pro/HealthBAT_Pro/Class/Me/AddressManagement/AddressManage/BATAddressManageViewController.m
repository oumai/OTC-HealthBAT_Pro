...
{
    [HTTPTool requestWithOTCURLString:@"/api/custom/SetDefaultContact" parameters:@{@"Id":addressData.ID} type:kGET success:^(id responseObject) {
...
{
    [HTTPTool requestWithOTCURLString:@"/api/custom/DelContactInfo" parameters:@{@"Id":addressData.ID} type:kGET success:^(id responseObject) {
