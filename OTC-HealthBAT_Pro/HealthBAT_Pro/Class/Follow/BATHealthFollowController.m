...
- (BATCustomScrollView *)bgScrollView{
    if (!_bgScrollView) {
        _bgScrollView = [[BATCustomScrollView alloc]initWithFrame:CGRectMake(0, CGRectGetMaxY(self.segmentController.frame), SCREEN_WIDTH, SCREEN_HEIGHT - kNAVIGATION_STATUS_BAR_HEIGHT - kTAB_BAR_HEIGHT - kSEGMENTEDCONTROL_HEIGHT )];
