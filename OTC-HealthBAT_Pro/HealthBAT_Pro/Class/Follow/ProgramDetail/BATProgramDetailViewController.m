...
- (void)settingClock:(BOOL)flag
{
    ...
    if (flag) {
        for (BATProgramItem *programItem in self.programDetailModel.Data.ProgrammeLst) {
            ...
            [clockManager settingClock:programItem.Title body:programItem.ResultDesc clockTime:programItem.JobTime identifier:[NSString stringWithFormat:@"template_%ld_%ld",(long)self.templateID,(long)programItem.ID] nextDay:NO];
