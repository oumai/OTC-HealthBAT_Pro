...
- (void)viewWillAppear:(BOOL)animated{
    ...
    if (self.type == kConsultTypeTextAndImage) {
        [TalkingData trackEvent:@"100015" label:@"图文咨询"];
    }else if(self.type == kConsultTypeVideo){
        [TalkingData trackEvent:@"100017" label:@"视频咨询"];
    }else if(self.type == kConsultTypeAudio){
        [TalkingData trackEvent:@"100016" label:@"语音咨询"];
    }
}
