...
- (void)viewDidLoad {
    ...
    NSArray *nameArr = @[@"综合",@"疾病",@"症状",@"药品",@"医院",@"养老院",@"医生",@"资讯"];
    // 2 控制器数组和标题数组
    NSMutableArray *arrM = [NSMutableArray array];
    NSMutableArray *titleArrM = [NSMutableArray arrayWithCapacity:10];
    for (NSInteger i = 0; i < nameArr.count; i++) {
        if (i == 0) {
            BATSynthesizeSearchViewController *synthesizeVC = [BATSynthesizeSearchViewController new];
            [arrM addObject:synthesizeVC];
            NSString *title = [NSString stringWithFormat:@"%@",nameArr[i]];
            [titleArrM addObject:title];

        }else if (i == 1) {
        
            BATSearchDieaseListViewController *dieaseListVC = [BATSearchDieaseListViewController new];
            [arrM addObject:dieaseListVC];
            NSString *title = [NSString stringWithFormat:@"%@",nameArr[i]];
            [titleArrM addObject:title];
            ...
            BATSearchSymptomListViewController *symptomListVC = [BATSearchSymptomListViewController new];
            [arrM addObject:symptomListVC];
            NSString *title = [NSString stringWithFormat:@"%@",nameArr[i]];
            [titleArrM addObject:title];

        } else if(i == 3){
        
            BATDrugSearchListViewController *drugListVC = [BATDrugSearchListViewController new];
            [arrM addObject:drugListVC];
            NSString *title = [NSString stringWithFormat:@"%@",nameArr[i]];
            [titleArrM addObject:title];
            ...
            BATHosptialSearchListViewController *drugListVC = [BATHosptialSearchListViewController new];
            [arrM addObject:drugListVC];
            NSString *title = [NSString stringWithFormat:@"%@",nameArr[i]];
            [titleArrM addObject:title];
            ...
            BATGeracomiumSearchListViewController *drugListVC = [BATGeracomiumSearchListViewController new];
            [arrM addObject:drugListVC];
            NSString *title = [NSString stringWithFormat:@"%@",nameArr[i]];
            [titleArrM addObject:title];
            ...
            BATDoctorSearchListViewController *drugListVC = [BATDoctorSearchListViewController new];
            [arrM addObject:drugListVC];
            NSString *title = [NSString stringWithFormat:@"%@",nameArr[i]];
            [titleArrM addObject:title];
            ...
            BATInfoSearchListViewController *drugListVC = [BATInfoSearchListViewController new];
            [arrM addObject:drugListVC];
            NSString *title = [NSString stringWithFormat:@"%@",nameArr[i]];
            [titleArrM addObject:title];
