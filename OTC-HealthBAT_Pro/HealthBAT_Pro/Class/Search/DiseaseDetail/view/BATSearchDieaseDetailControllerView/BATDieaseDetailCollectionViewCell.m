...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    NSDictionary *dict = @{@"resultId":searchContent.resultId,@"resultTitle":searchContent.resultTitle,@"dataType":@(searchContent.dataType),@"pathName":searchContent.resultTitle,@"type":searchContent.resultType};
