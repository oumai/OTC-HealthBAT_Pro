...
- (UIImageView *)chatImage{
    if (!_chatImage) {
        ...
        _chatImage.image = [UIImage imageNamed:@"ic-Picture-consulting"];
    }
...
- (UIImageView *)audioimage{
    if (!_audioimage) {
        ...
        _audioimage.image = [UIImage imageNamed:@"ic-Voice"];
    }
...
- (UIImageView *)videoImage{
    if (!_videoImage) {
        ...
        _videoImage.image = [UIImage imageNamed:@"ic-video"];
    }
...
- (BATGraditorButton *)chatContentLb{
    if (!_chatContentLb) {
        ...
        [_chatContentLb setTitle:@"0.00元/次" forState:UIControlStateNormal] ;
...
- (BATGraditorButton *)AudioContentLb{
    if (!_AudioContentLb) {
        ...
        [_AudioContentLb setTitle:@"0.00元/次" forState:UIControlStateNormal] ;
...
- (BATGraditorButton *)ViedoContentLb{
    if (!_ViedoContentLb) {
        ...
        [_ViedoContentLb setTitle:@"0.00元/次" forState:UIControlStateNormal] ;
