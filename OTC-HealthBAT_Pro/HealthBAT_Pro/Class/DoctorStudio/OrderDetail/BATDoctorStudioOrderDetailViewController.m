...
static  NSString * const DETAIL_CELL = @"BATDoctorStudioOrderDetailTableViewCell.h";
static  NSString * const STATUS_CELL = @"BATDoctorStudioOrderDetailOrderStatusTableViewCell.h";
