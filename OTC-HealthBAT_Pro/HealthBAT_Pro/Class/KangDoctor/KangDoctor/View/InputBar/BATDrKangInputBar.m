...
- (void)changeInputMode:(UIButton *)changeBtn {
    ...
    self.soundInputButton.hidden = !self.soundInputButton.hidden;
    
    if (self.textView.hidden == NO) {
        [self.textView becomeFirstResponder];
        [_changeButton setImage:[UIImage imageNamed:@"icon-yly"] forState:UIControlStateNormal];
        [_notiBtn setTitle:@" 免打字" forState:UIControlStateNormal];
    }
    else {
