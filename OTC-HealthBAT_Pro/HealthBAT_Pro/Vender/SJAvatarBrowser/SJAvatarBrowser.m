...
+(void)showImage:(UIImageView *)avatarImageView isQRCode:(BOOL)isQRCode {
    ...
    [UIView animateWithDuration:0.3 animations:^{
        ...
        imageView.frame=CGRectMake(10,([UIScreen mainScreen].bounds.size.height-image.size.height*[UIScreen mainScreen].bounds.size.width/image.size.width)/2, [UIScreen mainScreen].bounds.size.width-20, image.size.height*([UIScreen mainScreen].bounds.size.width-20)/image.size.width);
