...
- (void)bat_loginTIM{
    ...
    if (!TIMData) {
        ...
        [HTTPTool requestWithURLString:@"/api/Account/GetIMConfig" parameters:nil type:kGET success:^(id responseObject) {
            ...
            BATTIMDataModel *data= [BATTIMDataModel mj_objectWithKeyValues:responseObject];
...
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
                ...
                if ([customElem.ext isEqualToString:@"Order.Buy.Recipe"] || [customElem.ext isEqualToString:@"Recipe.Preview"]) {
                    ...
                    UIAlertController * alert = [UIAlertController alertControllerWithTitle:@"您收到了一条处方信息" message:@"是否查看处方单信息" preferredStyle:UIAlertControllerStyleAlert];
                    ...
                    UIAlertAction *okAction = [UIAlertAction actionWithTitle:@"去查看" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
                        ...
                        BATMyPrescriptionVC *myPrescriptionVC = [[BATMyPrescriptionVC alloc] init];
                        myPrescriptionVC.hidesBottomBarWhenPushed = YES;
                        [currentNav pushViewController:myPrescriptionVC animated:NO];
