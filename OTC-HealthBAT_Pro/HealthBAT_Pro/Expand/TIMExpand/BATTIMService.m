...
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
                ...
                if ([customElem.ext isEqualToString:@"Room.StateChanged"]) {
                    ...
                    [[NSNotificationCenter defaultCenter] postNotificationName:@"CUSTOM_MESSAGE_Room.StateChanged" object:self userInfo:dic];
                }
                ...
                if ([customElem.ext isEqualToString:@"Order.Buy.Recipe"] || [customElem.ext isEqualToString:@"Recipe.Preview"]) {
                    ...
                    [[NSNotificationCenter defaultCenter] postNotificationName:@"CUSTOM_MESSAGE_Order.Buy.Recipe" object:self userInfo:dic];
                }
