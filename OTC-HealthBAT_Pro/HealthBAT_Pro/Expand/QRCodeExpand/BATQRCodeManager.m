...
@implementation BATQRCodeManager
...
+ (id)createQRCode:(NSString *)string warterImage:(UIImage *)warterImage
{
    ...
    return  [BATQRCodeManager createNonInterpolatedUIImageFormCIImage:outputImage withSize:200 waterImageSize:40 waterImage:warterImage];//重绘二维码,使其显示清晰
}
