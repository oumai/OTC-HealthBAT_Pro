...
/**
 ...
 - BATOTCOrderType_PrescriptionDrugs: 处方药
 - BATOTCOrderType_NonPrescriptionDrugs: 非处方药
 */
typedef NS_ENUM(NSInteger,BATOTCOrderType){
    BATOTCOrderType_PrescriptionDrugs = 1,
    BATOTCOrderType_NonPrescriptionDrugs = 2,
};

/**
 OTC收货方式

 - BATReceiveMethod_PickUp: 到药店取货
 - BATReceiveMethod_Delivery: 送货上门
 */
typedef NS_ENUM(NSInteger,BATReceiveMethod){
    BATReceiveMethod_PickUp = 1,
    BATReceiveMethod_Delivery = 2,
};
