...
+ (void)updateVersion {
    ...
    NSString *url = [NSString stringWithFormat:@"http://itunes.apple.com/cn/lookup?id=%@",BAT_OTC_APPSTORE_ID];
    ...
    [XMCenter sendRequest:^(XMRequest *request) {
        ...
        if (isUpdate) {
            ...
            UIAlertAction * okAction = [UIAlertAction actionWithTitle:@"去更新"
                                        ...
                                        {
                                            [[UIApplication sharedApplication] openURL:[NSURL URLWithString:[NSString stringWithFormat:@"itms-apps://itunes.apple.com/app/id%@?mt=8",BAT_OTC_APPSTORE_ID]]];
